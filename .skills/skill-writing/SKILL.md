...
5. Validate the skill against a few realistic trigger prompts and revise the description if triggering would be ambiguous.
6. Update `AGENTS.md` only when root-level discovery or policy changes are needed.
